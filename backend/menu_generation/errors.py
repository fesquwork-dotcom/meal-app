...
class CatalogGenerationError(Exception):
    ...
    CATALOG_REPLACEMENT_NOT_FOUND = "CATALOG_REPLACEMENT_NOT_FOUND"
    CATALOG_REPLACEMENT_ROUTING_ERROR = "CATALOG_REPLACEMENT_ROUTING_ERROR"
    STRATEGY_INFEASIBLE = "STRATEGY_INFEASIBLE"

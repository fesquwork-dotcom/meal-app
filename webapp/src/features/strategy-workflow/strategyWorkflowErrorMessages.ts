...
const CODE_MESSAGES: Record<string, string> = {
  ...
  MENU_GENERATION_INVALID: 'Не удалось составить корректное меню. Попробуйте ещё раз.',
  ...
  GENERATION_INTERRUPTED: 'Генерация была прервана. Запустите её ещё раз.',
  GENERATION_FAILED: 'Не удалось создать меню. Попробуйте ещё раз.',
  GENERATION_SAVE_FAILED: 'Не удалось сохранить меню. Попробуйте ещё раз.',
